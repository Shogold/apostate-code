import { TenetMeta } from "./tenet-meta";

export const tenets: Array<TenetMeta> = [
    new TenetMeta('Apostasy is the only way to live an authentic life', 'tenet/authentic-life'),
    new TenetMeta('Morality is relative, not absolute', 'tenet/morality'),
    new TenetMeta('Life is iterative, not progressive', 'tenet/agile-life'),
    new TenetMeta('Trauma must be integrated, not rejected', 'tenet/trauma'),
